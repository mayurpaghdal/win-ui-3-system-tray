...
namespace Hardcodet.Wpf.TaskbarNotification.Interop
{
    public class WindowsTrayIcon
    {
        ...
        public WindowsTrayIcon(string iconFile)
        {
            ...
            iconData.ToolTipText = "TB Sys tray App";
        ...
        private void CreateTaskbarIcon()
        {
            lock (lockObject)
            {
                ...
                const IconDataMembers members = IconDataMembers.Message
                                                ...
                                                | IconDataMembers.Tip
                                                | IconDataMembers.UseLegacyToolTips;
        ...
        private void ModifyTaskbarIcon()
        {
            iconData = NotifyIconData.CreateDefault(messageSink.MessageWindowHandle, "ActivityTrayIcon.icon");
            iconData.ToolTipText = "Tracking is running";
            WriteIconData(ref iconData, NotifyCommand.Modify);

            //var path = Assembly.GetExecutingAssembly().Location;
            //var filePath = Path.Combine(Path.GetDirectoryName(path), "");
            //App.m_appWindow.SetIcon(filePath);
        }
