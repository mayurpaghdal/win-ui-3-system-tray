...
namespace SysTrayWinUI3Poc.Helper
{
    /// <summary>
    ...
    public class RootFrameNavigationHelper
    {
        ...
        public RootFrameNavigationHelper(Frame rootFrame, Microsoft.UI.Xaml.Controls.NavigationView currentNavView)
        {
            ...
            //this.systemNavigationManager = NavigationManager.GetForCurrentView();
            ...
            //App.Instance.Window.CoreWindow.Dispatcher.AcceleratorKeyActivated +=
            //    CoreDispatcher_AcceleratorKeyActivated;
            //App.Instance.Window.CoreWindow.PointerPressed +=
        ...
        internal void Navigate(Type pageType, object parameters = null)
        {
