...
namespace SysTrayWinUI3Poc.Helpers
{
    public static class ThemeHelper
    {
        ...
        public static ElementTheme ActualTheme
        {
            get
            {
                ...
                return AppCommon.GetEnum<ElementTheme>(Application.Current.RequestedTheme.ToString());
            }
        }
        ...
        public static void Initialize()
        {
            ...
            if (savedTheme != null)
            {
                RootTheme = AppCommon.GetEnum<ElementTheme>(savedTheme);
            }
